...
TEST(S2OPCUA, OPCUA_Server) {
    ...
    // Create READING 1
    {
        ...
        TestReading elem("opcua_xxx", "sps", 0x1234);
        elem.pushIntValue(0, &readings);
    ...
    {
        // ** HERE ** INVALID "do_id"
        TestReading elem("opcua_mvi", "mvi_unknown");
        elem.pushIntValue(561, &readings);
    ...
    {
        readings.clear();
        TestReading elem("opcua_mvi", "mvi", 0x40000000);
        elem.pushIntValue(560, &readings);
